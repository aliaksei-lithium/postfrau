...
/// this by `make skill`.
///
/// Written for an agent that has been handed a job in words and should not have to discover the
/// tool first: the recipe comes before the reference, and every command is shown rather than
/// described.
enum SkillDocument {
    static let text = #"""
---
